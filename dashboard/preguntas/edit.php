...
<html lang="en">
  ...
  <body>
    ...
    $id_pregunta = $_GET["id"];
    $sentencia = $mysqli->prepare("SELECT id_pregunta, id_encuesta, titulo, id_tipo_pregunta FROM preguntas WHERE id_pregunta = ?");
            ...
            <div class="col-12">
                ...
                <form action="update.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo $pregunta["titulo"] ?>" placeholder="Titulo" class="form-control" type="text" name="titulo" id="titulo" required>
                    </div>
